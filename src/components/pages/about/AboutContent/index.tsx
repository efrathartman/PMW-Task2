...
// import { AboutContentProps } from "@/models/props";
// import styles from "./index.module.css";

// const AboutContent: React.FC<AboutContentProps> = ({ title }) => {
//   return (
...
//         This is the about page content using Material UI components.
//       </Typography>
...
//           </Typography>
//           <Button variant="contained" sx={{ mt: 2 }} onClick={() => alert("Learn more clicked")}>
//             Learn More
//           </Button>
//         </Box>
//       )}
...
const AboutContent: React.FC = () => {
  const [selectedTab, setSelectedTab] = useState("what-we-do");
  const [showMore, setShowMore] = useState(false); // ✅ חדש
      ...
      {selectedTab === "what-we-do" && (
        <Box>
          ...
          <Button
            variant="contained"
            sx={{ mt: 2 }}
            onClick={() => setShowMore((prev) => !prev)} // ✅ משנה את ה־state
          >
            {showMore ? "Hide Details" : "Learn More"}
          </Button>

          {/* ✅ תוכן נוסף שמופיע רק אם showMore=true */}
          {showMore && (
